...
const ja = {
  ...
  "ui.recentFilesHeading": "最近読み込んだファイル",
  ...
  "ui.dummyTextDesc":
    "選択した要素のテキストを、元の文字数を維持したまま指定した文字に置き換えます。",
  "ui.dummyTextPlaceholder": "テキスト",
  "ui.maskImageLabel": "マスク画像",
  "ui.maskImageDesc": "選択した要素の画像にマスクを適用します。",
  "ui.settings": "設定",
...
const en: Dict = {
  ...
  "ui.recentFilesHeading": "Recently opened files",
  ...
  "ui.maskImageDesc": "Apply a mask to images in the selected elements.",
...
const fr: Dict = {
  ...
  "ui.dropAreaSuffix": "",
  "ui.recentFilesHeading": "Fichiers récents",
  ...
  "ui.dummyTextDesc":
    "Remplace le texte des éléments sélectionnés par le caractère choisi en conservant le nombre de caractères.",
  "ui.dummyTextPlaceholder": "Texte",
  "ui.maskImageLabel": "Masque d'image",
  "ui.maskImageDesc":
    "Applique un masque aux images des éléments sélectionnés.",
...
const ko: Dict = {
  ...
  "ui.dummyTextDesc":
    "선택한 요소의 텍스트를 원래 글자 수를 유지한 채 지정한 문자로 교체합니다.",
  "ui.dummyTextPlaceholder": "텍스트",
  "ui.maskImageLabel": "마스크 이미지",
  "ui.maskImageDesc": "선택한 요소의 이미지에 마스크를 적용합니다.",
  "ui.settings": "설정",
...
const pt: Dict = {
  ...
  "ui.dropAreaSuffix": "",
  "ui.recentFilesHeading": "Arquivos recentes",
...
const de: Dict = {
  ...
  "ui.recentFilesHeading": "Zuletzt geöffnete Dateien",
